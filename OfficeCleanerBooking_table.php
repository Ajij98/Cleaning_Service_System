<?php
 ...
 <?php
   ...
   $db   = new Database();
   $sql  = "SELECT * FROM tb_office_cleaning_booking WHERE user_name = '$user_name'";
   $read = $db->select($sql);
  ?>
  ...
  <head>
    ...
    <link
      ...
      <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/5.0.0-alpha1/css/bootstrap.min.css"
        ...
        <title>Office Cleaner Booking table</title>
      </head>
      <body>
      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="pl-5 pr-5 col-lg-12 col-xlg-12 col-md-12">
            <div class="card">
              <div class="card-body">
                <a href="OfficeCleaningService.php" class="btn btn-danger mb-4">Back</a>
                ...
                <table id="VisitorDt" class="table table-striped table-sm table-bordered" cellspacing="0" width="100%">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><a href="Update_Office_CleanerBooking.php?office_cleaning_booking_id=<?php echo $result['office_cleaning_booking_id']; ?>" class="btn btn-info btn-sm">Update</a> || <a href="delete_data.php?office_cleaning_booking_id=<?php echo $result['office_cleaning_booking_id']; ?>" onclick="return confirm('Are you sure you want to delete this item?')" class="btn btn-danger btn-sm">Delete</a></td>
                    </tr>
                    <?php } ?>
                    <?php }else{ ?>
