<?php
 ...
 <?php
   $db   = new Database();
   $sql  = "SELECT * FROM tb_vehicle_cleaning_service";
   $read = $db->select($sql);
  ?>
 ...
 <?php
   ...
   if(isset($_POST['submit']))
   {
     if(checkPhone())
     {
       ...
       $sql = "INSERT INTO          tb_vehicle_cleaning_booking(name,phone,email,address,city,postcode,vehicle,amount,cleaning_product,time,date,total_amount,user_name,entry_time)values('$name','$phone','$email','$address','$city','$postcode','$vehicle','$amount','$cleaning_product','$time','$date','$total_amount','$user_name','$current_datetime')";
    ...
    <head>
        ...
        <link
            ...
            <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/5.0.0-alpha1/css/bootstrap.min.css"
                ...
                <title>Vehicle Cleaner Booking</title>
            </head>
            <body>
                        ...
                        <form action="" method="post" enctype="multipart/form-data" autocomplete="off">
                          <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 mt-4">
                                    <div class="form-group">
                                        ...
                                        <select id="inputCleaningProducts" class="form-select" name="vehicle" required>
                                          <option selected>Choose...</option>
                                          <?php if($read){?>
                                          <?php while($result = $read->fetch_assoc()){ ?>
                                            <option ><?php echo $result['vehicle']; ?></option>
                                          <?php } ?>
                                          <?php }else{ ?>
                            ...
                            <div class="row mt-4 mb-4">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <input class="form-control" name="total_amount" placeholder="" required>
                                    </div>
                                </div>
                            </div>
