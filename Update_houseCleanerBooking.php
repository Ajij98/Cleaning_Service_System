<?php
 ...
 <?php
   ...
   if(isset($_GET['house_cleaning_booking_id']))
   {
     ...
     $sql    = "SELECT * FROM tb_house_cleaning_booking WHERE house_cleaning_booking_id = $house_cleaning_booking_id";
     ...
     while($getData = $result->fetch_assoc())
     {
       ...
       $no_of_bedroom      = $getData['no_of_bedroom'];
       $badroom_amount     = $getData['badroom_amount'];
       $no_of_kitchen      = $getData['no_of_kitchen'];
       $kitchenroom_amount = $getData['kitchenroom_amount'];
       $no_of_livingroom   = $getData['no_of_livingroom'];
       $livingroom_amount  = $getData['livingroom_amount'];
       $no_of_bathroom     = $getData['no_of_bathroom'];
       $bathroom_amount    = $getData['bathroom_amount'];
       $no_of_carpet       = $getData['no_of_carpet'];
       $carpet_amount      = $getData['carpet_amount'];
  ...
  <?php
   ...
   if(isset($_POST['update']))
   {
     if(checkPhone())
     {
       ...
       $sql = "UPDATE tb_house_cleaning_booking SET name='$name',phone='$phone',email='$email',address='$address',city='$city',postcode='$postcode',no_of_bedroom='$no_of_bedroom',badroom_amount='$badroom_amount',no_of_kitchen='$no_of_kitchen',kitchenroom_amount='$kitchenroom_amount',no_of_livingroom='$no_of_livingroom',livingroom_amount='$livingroom_amount',no_of_bathroom='$no_of_bathroom',bathroom_amount='$bathroom_amount',no_of_carpet='$no_of_carpet',carpet_amount='$carpet_amount',cleaning_product='$cleaning_product',time='$time',date='$date',total_amount='$total_amount',user_name='$user_name',entry_time='$current_datetime' WHERE house_cleaning_booking_id = $house_cleaning_booking_id";
  ...
  <head>
    ...
    <link
      ...
      <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/5.0.0-alpha1/css/bootstrap.min.css"
        ...
        <title>Update House Cleaner Booking</title>
      </head>
      <body>
        <!-- nav bar -->
            ...
            <form action="" method="post" enctype="multipart/form-data" autocomplete="off">
                ...
                <div class="row">
                  ...
                  <div>
                    ...
                    <div class="col-md-8">
                        <div class="form-group">
                            <input type="number" id="no_of_bedroom" name="no_of_bedroom" onchange="myChangeFunction1(this)" class="form-control" value="<?php echo $no_of_bedroom; ?>" placeholder="No of Bedroom">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <input id="badroom_amount" name="badroom_amount" class="form-control" value="<?php echo $badroom_amount; ?>" placeholder="Amount">
                        </div>
                    </div>
                    ...
                    <div class="col-md-8">
                        <div class="form-group">
                            <input type="number" id="no_of_kitchen" name="no_of_kitchen" onchange="myChangeFunction2(this)" class="form-control" value="<?php echo $no_of_kitchen; ?>" placeholder="No of Kitchen">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <input id="kitchenroom_amount" name="kitchenroom_amount" class="form-control" value="<?php echo $kitchenroom_amount; ?>" placeholder="Amount">
                        </div>
                    </div>
                    ...
                    <div class="col-md-8">
                        <div class="form-group">
                            <input type="number" id="no_of_livingroom" name="no_of_livingroom" onchange="myChangeFunction3(this)" class="form-control" value="<?php echo $no_of_livingroom; ?>" placeholder="No of Living Room">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <input id="livingroom_amount" name="livingroom_amount" class="form-control" value="<?php echo $livingroom_amount; ?>" placeholder="Amount">
                        </div>
                    </div>
                    ...
                    <div class="col-md-8">
                        <div class="form-group">
                            <input type="number" id="no_of_bathroom" name="no_of_bathroom" onchange="myChangeFunction4(this)" class="form-control" value="<?php echo $no_of_bathroom; ?>" placeholder="No of Bathroom">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <input id="bathroom_amount" name="bathroom_amount" class="form-control" value="<?php echo $bathroom_amount; ?>" placeholder="Amount">
                        </div>
                    </div>
                    ...
                    <div class="col-md-8">
                        <div class="form-group">
                            <input type="number" id="no_of_carpet" name="no_of_carpet" onchange="myChangeFunction5(this)" class="form-control" value="<?php echo $no_of_carpet; ?>" placeholder="No of Carpet">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <input id="carpet_amount" name="carpet_amount"  class="form-control" value="<?php echo $carpet_amount; ?>" placeholder="Amount">
                        </div>
                    </div>
                ...
                <div class="row mt-4 mb-4">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <input type="number" class="form-control" id="total_amount" name="total_amount"  value="<?php echo $total_amount; ?>" required>
                        </div>
                    </div>
