...
<head>
    ...
    <link rel="stylesheet" href="css/OfficeCleaningService.css">
            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    <div class="finix-text text-center">
                        <a href="OfficeCleanerBookingForm.php" class="btn btn-primary m-4"> Book Now </a>
                        <a href="OfficeCleanerBooking_table.php" class="btn btn-primary m-4"> My Booking </a>
