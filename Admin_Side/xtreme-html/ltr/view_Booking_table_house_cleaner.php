 ...
 <?php
   ...
   if(isset($_GET['house_cleaning_booking_id']))
   {
     ...
     while($getData = $result->fetch_assoc())
     {
       ...
       $house_cleaning_booking_id = $getData['house_cleaning_booking_id'];
       $name               = $getData['name'];
       $phone              = $getData['phone'];
       $email              = $getData['email'];
...
<head>
    ...
    <title>View Booking table House Cleaner</title>
        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-12">
                        <h4 class="page-title">View Booking table House Cleaner</h4>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#">Home</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">View Booking table House Cleaner</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <form class="form-horizontal form-material">
                                   <p><strong>Booking_Id: <?php echo $house_cleaning_booking_id; ?></strong></p>
                                    <p><strong>Name: <?php echo $name; ?></strong></p>
                                    <p><strong>Phone: <?php echo $phone; ?></strong></p>
                                    <p><strong>E-mail: <?php echo $email; ?></strong></p>
                                    <p><strong>Address: <?php echo $address; ?></strong></p>
                                    <p><strong>City: <?php echo $city; ?></strong></p>
                                    <p><strong>Postal_code: <?php echo $postcode; ?></strong></p>
                                    <p><strong>Bedroom: <?php echo $no_of_bedroom; ?> Amount: <?php echo $badroom_amount; ?></strong></p>
                                    <p><strong>Kitchen: <?php echo $no_of_kitchen; ?> Amount: <?php echo $kitchenroom_amount; ?></strong></p>
                                    <p><strong>Living_room: <?php echo $no_of_livingroom; ?> Amount: <?php echo $livingroom_amount; ?></strong></p>
                                    <p><strong>Bathroom: <?php echo $no_of_bathroom; ?> Amount: <?php echo $bathroom_amount; ?></strong></p>
                                    <p><strong>Carpet: <?php echo $no_of_carpet; ?> Amount: <?php echo $carpet_amount; ?></strong></p>
                                    <p><strong>Cleaning Product: <?php echo $cleaning_product; ?></strong></p>
                                    ...
                                    <p><strong>Username: <?php echo $user_name; ?></strong></p>
                                    <p><strong>Entry time: <?php echo $entry_time; ?></strong></p>
                                </form>
                            </div>
                        </div>
                    </div>
