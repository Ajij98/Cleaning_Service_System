            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 col-xlg-12 col-md-12">
                        <div class="card">
                            <div class="card-body">
                                <!-- <a href="add_new_staff.html" class="btn btn-danger mb-4">Add New Staff</a> -->
                                <table id="VisitorDt" class="table table-striped table-sm table-bordered" cellspacing="0" width="100%">
                                  ...
                                  <tbody>
                                    ...
                                    <tr>
                                      ...
                                      <td><a href="delete_data.php?user_id=<?php echo $result['user_id']; ?>" onclick="return confirm('Are you sure you want to delete this item')" class="btn btn-danger">Delete</a></td>
                                    </tr>
                                    <?php } ?>
                                    <?php }else{ ?>
