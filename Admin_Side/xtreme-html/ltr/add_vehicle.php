<?php
 ...
 <?php
   ...
   if(isset($_POST['submit']))
   {
       ...
       $sql = "INSERT INTO          tb_vehicle_cleaning_service(vehicle,amount,user_name,entry_time)values('$vehicle','$amount','$user_name','$current_datetime')";
        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-12">
                        <h4 class="page-title">Vehicle Washing page</h4>
