 ...
 <?php
   ...
   if(isset($_GET['office_cleaning_booking_id']))
   {
     ...
     while($getData = $result->fetch_assoc())
     {
       ...
       $office_cleaning_booking_id = $getData['office_cleaning_booking_id'];
       $name               = $getData['name'];
       $phone              = $getData['phone'];
       $email              = $getData['email'];
...
<head>
    ...
    <title>View Booking table Office Cleaner</title>
        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-12">
                        <h4 class="page-title">View Booking table Office Cleaner</h4>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#">Home</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">View Booking table Office Cleaner</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <form class="form-horizontal form-material">
                                  <p><strong>Booking_Id: <?php echo $office_cleaning_booking_id; ?></strong></p>
                                   ...
                                   <p><strong>No Of Cleaner: <?php echo $nmbr_of_cleaner; ?></strong></p>
                                   <p><strong>Hour: <?php echo $hour; ?></strong></p>
