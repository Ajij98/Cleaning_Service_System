<?php
 ...
 <?php
   ...
   if(isset($_GET['office_cleaning_service_id']))
   {
     ...
     $sql    = "SELECT * FROM tb_office_cleaning_service WHERE office_cleaning_service_id = $office_cleaning_service_id";

     $result = $db->select($sql);

     while($getData = $result->fetch_assoc())
     {
       $no_of_cleaner = $getData['no_of_cleaner'];
       $hour          = $getData['hour'];
  ...
  <?php
   ...
   if(isset($_POST['update']))
   {
     ...
     $no_of_cleaner = $_POST['no_of_cleaner'];
     $hour          = $_POST['hour'];
     $amount        = $_POST['amount'];
     $user_name     = $user_name;

     $sql = "UPDATE tb_office_cleaning_service SET no_of_cleaner='$no_of_cleaner',hour='$hour',amount='$amount',user_name='$user_name',entry_time='$current_datetime' WHERE office_cleaning_service_id = $office_cleaning_service_id";
        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-12">
                        <h4 class="page-title">Update office Cleaning Service</h4>
                            ...
                            <div class="card-body">
                              <form class="form-horizontal form-material" action="" method="post" enctype="multipart/form-data" autocomplete="off">
                                  <div class="form-group">
                                      <label class="col-md-12">Add No of cleaner</label>
                                      <div class="col-md-12">
                                          <input type="number" name="no_of_cleaner" placeholder=""
                                              class="form-control form-control-line" value="<?php echo $no_of_cleaner; ?>" required>
                                      </div>
                                  </div>
                                  <div class="form-group">
                                      <label class="col-md-12">Add Hour</label>
                                      <div class="col-md-12">
                                          <input type="number" name="hour" placeholder=""
                                              class="form-control form-control-line" value="<?php echo $hour; ?>" required>
                                      </div>
                                  </div>
                                  <div class="form-group">
