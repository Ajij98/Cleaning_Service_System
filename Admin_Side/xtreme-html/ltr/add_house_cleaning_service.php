<?php
 ...
 <?php
   ...
   if(isset($_POST['submit']))
   {
       ...
       $sql = "INSERT INTO          tb_house_cleaning(service_name,amount,user_name,entry_time)values('$service_name','$amount','$user_name','$current_datetime')";
...
<head>
    ...
    <title>Add house Cleaning Service</title>
        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-12">
                        <h4 class="page-title">Add house Cleaning Service</h4>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#">Home</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Add house Cleaning Service</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                            ...
                            <div class="card-body">
                                ...
                                " autocomplete="off">
                                    <div class="form-group">
                                        <label class="col-md-12">Add house Cleaning Service</label>
                                        <div class="col-md-12">
