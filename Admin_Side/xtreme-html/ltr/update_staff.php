 ...
 <?php
   ...
   if(isset($_GET['staff_id']))
   {
     ...
     while($getData = $result->fetch_assoc())
     {
       ...
       $image        = $getData['image'];
       $working_type = $getData['working_type'];
  ...
  date_default_timezone_set('Asia/Dhaka');
   ...
   if(isset($_POST['update']))
   {
     ...
     if($image != "")
     {
       ...
       $sql = "UPDATE tb_staff SET name='$name',phone='$phone',email='$email',district='$district',address='$address',experience='$experience',image='$dst_db',working_type='$working_type',added_by='$added_by',entry_time='$current_datetime' WHERE staff_id = $staff_id";

       $update_row = $db->update($sql);
     }

     $sql = "UPDATE tb_staff SET name='$name',phone='$phone',email='$email',district='$district',address='$address',experience='$experience',working_type='$working_type',added_by='$added_by',entry_time='$current_datetime' WHERE staff_id = $staff_id";
                        ...
                        <div class="card">
                            <div class="card-body">
                              <form class="form-horizontal form-material" action="" method="post" enctype="multipart/form-data" autocomplete="off">
                                  <div class="form-group">
                                      ...
                                      <div class="col-md-12">
                                          <input type="text" name="name" placeholder=""
                                              class="form-control form-control-line" value="<?php echo $name; ?>" required>
                                      </div>
                                  </div>
                                  <div class="form-group">
                                      ...
                                      <div class="col-md-12">
                                          <input type="number" name="phone" placeholder=""
                                              class="form-control form-control-line" value="<?php echo $phone; ?>" required>
                                      </div>
                                  </div>
                                  <div class="form-group">
                                      ...
                                      <div class="col-md-12">
                                          <input type="email" name="email" placeholder="info@gmail.com"
                                              class="form-control form-control-line" value="<?php echo $email; ?>" name="example-email"
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-md-12">
                                          <input type="text" name="address" placeholder=""
                                              class="form-control form-control-line" value="<?php echo $address; ?>" required>
                                      </div>
                                  </div>
                                  <div class="form-group">
                                      ...
                                      <div class="col-sm-12">
                                          <select class="form-control form-control-line" name="experience" required>
                                              <option selected><?php echo $experience; ?></option>
                                              <option>1</option>
                                              <option>2</option>
                                              <option>3</option>
                                              <option>4</option>
                                  ...
                                  <div class="form-group">
                                    <img src="<?php echo $image; ?>"  height="80">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-sm-12">
                                          <select class="form-control form-control-line" name="working_type" required>
                                              <option selected><?php echo $working_type; ?></option>
