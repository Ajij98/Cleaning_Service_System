            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 col-xlg-12 col-md-12">
                        <div class="card">
                            <div class="card-body">
                                <a href="add_new_staff.php" class="btn btn-danger mb-4">Add New Staff</a>
                                <table id="VisitorDt" class="table table-striped table-sm table-bordered" cellspacing="0" width="100%">
                                  <thead>
                                    <tr>
                                      ...
                                      <th class="th-sm">Staff Picture</th>
                                      <th class="th-sm">Working Type</th>
                                  ...
                                  <tbody>
                                    ...
                                    <tr>
                                      ...
                                      <td><img src="<?php echo $result['image']; ?>" height="60"></td>
                                      <td><?php echo $result['working_type']; ?></td>

                                      <td><a href="update_staff.php?staff_id=<?php echo $result['staff_id']; ?>" class="btn btn-info">Update</a> || <a href="delete_data.php?staff_id=<?php echo $result['staff_id']; ?>" onclick="return confirm('Are you sure you want to delete this item')" class="btn btn-danger">Delete</a></td>
                                    </tr>
                                    <?php } ?>
                                    <?php }else{ ?>
