...
<html dir="ltr" lang="en">
    <head>
        ...
        <title>Booking Table House Cleaner</title>
                                    ...
                                    <div class="page-wrapper">
                                        ...
                                        <div class="page-breadcrumb">
                                            <div class="row align-items-center">
                                                <div class="col-12">
                                                    <h4 class="page-title">Booking Table House Cleaner</h4>
                                                    <div class="d-flex align-items-center">
                                                        <nav aria-label="breadcrumb">
                                                            <ol class="breadcrumb">
                                                                <li class="breadcrumb-item"><a href="#">Home</a></li>
                                                                <li class="breadcrumb-item active" aria-current="page">Booking Table House Cleaner</li>
                                                            </ol>
                                                        </nav>
                                                    </div>
                                                </div>
                                                                  ...
                                                                  <tr>
                                                                    ...
                                                                    <td>
                                                                      ...
                                                                      else
                                                                      {
                                                                        ...
                                                                        <a href="house_cleaning_booking_verify.php?house_cleaning_booking_id=<?php echo $result['house_cleaning_booking_id']; ?>" class="btn btn-secondary btn-sm">Make Confirm</a>
                                                                        <?php
                                                                    ...
                                                                    <td><a href="view_Booking_table_house_cleaner.php?house_cleaning_booking_id=<?php echo $result['house_cleaning_booking_id']; ?>" class="btn btn-info btn-sm">View</a> || <a href="delete_data.php?house_cleaning_booking_id=<?php echo $result['house_cleaning_booking_id']; ?>" onclick="return confirm('Are you sure you want to delete this item?')" class="btn btn-danger btn-sm">Delete</a></td>
                                                                  </tr>
                                                                  <?php } ?>
                                                                  <?php }else{ ?>
