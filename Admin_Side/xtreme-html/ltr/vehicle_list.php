            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="pl-5 pr-5 col-lg-12 col-xlg-12 col-md-12">
                        <div class="card">
                            <div class="card-body">
                                <a href="add_vehicle.php" class="btn btn-danger mb-4">Add New Vehicle</a>
                                <table id="VisitorDt" class="table table-striped table-sm table-bordered" cellspacing="0" width="100%">
                                  <thead>
                                    <tr>
                                      <th class="th-sm">No</th>
                                      <th class="th-sm">Vehicle name</th>
                                  ...
                                  <tbody>
                                    ...
                                    <tr>
                                      ...
                                      <td><a href="update_vehicle.php?vehicle_cleaning_service_id=<?php echo $result['vehicle_cleaning_service_id']; ?>" class="btn btn-info">Update</a> || <a href="delete_data.php?vehicle_cleaning_service_id=<?php echo $result['vehicle_cleaning_service_id']; ?>" onclick="return confirm('Are you sure you want to delete this item')" class="btn btn-danger">Delete</a></td>
                                    </tr>
                                    <?php } ?>
                                    <?php }else{ ?>
