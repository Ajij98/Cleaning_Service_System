                        ...
                        <div class="card">
                            <div class="card-body">
                                <center class="m-t-30"> <img src="../../assets/images/users/5.jpg"
                                    ...
                                    <h4 class="card-title m-t-10">Username: <?php echo $_SESSION['user_name']; ?></h4>
                                </center>
                            </div>
                        </div>
                    </div>
                                  ...
                                  <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <input type="name" name="user_name" value="<?php echo $user_name ?>" class="form-control" placeholder="User Name" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <input type="email" name="email" value="<?php echo $email ?>" class="form-control" placeholder="info@gmail.com" required>
                                        </div>
                                    </div>
