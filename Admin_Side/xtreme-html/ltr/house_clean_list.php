<?php
 ...
 <!-- House Cleaning Service List -->
 <?php
   $db   = new Database();
   $sql  = "SELECT * FROM tb_house_cleaning";
   $read = $db->select($sql);
  ?>
        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-12">
                        <h4 class="page-title">House Clean list</h4>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#">Home</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Vehicle Washing page</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="pl-5 pr-5 col-lg-12 col-xlg-12 col-md-12">
                        <div class="card">
                            <div class="card-body">
                                <a href="add_house_cleaning_service.php" class="btn btn-danger mb-4">Add New Catagori</a>
                                <table id="VisitorDt" class="table table-striped table-sm table-bordered" cellspacing="0" width="100%">
                                  <thead>
                                    <tr>
                                      <th class="th-sm">No</th>
                                      <th class="th-sm">House cleaning Service</th>
                                  ...
                                  <tbody>
                                    ...
                                    <tr>
                                      ...
                                      <td><a href="update_house_cleaning_service.php?house_cleaning_id=<?php echo $result['house_cleaning_id']; ?>" class="btn btn-info">Update</a> || <a href="delete_data.php?house_cleaning_id=<?php echo $result['house_cleaning_id']; ?>" onclick="return confirm('Are you sure you want to delete this item')" class="btn btn-danger">Delete</a></td>
                                    </tr>
                                    <?php } ?>
                                    <?php }else{ ?>
