<?php
 ...
 <?php
   ...
   if(isset($_GET['vehicle_cleaning_service_id']))
   {
     ...
     $sql    = "SELECT * FROM tb_vehicle_cleaning_service WHERE vehicle_cleaning_service_id = $vehicle_cleaning_service_id";
  ...
  <?php
   ...
   if(isset($_POST['update']))
   {
     ...
     $sql = "UPDATE tb_vehicle_cleaning_service SET vehicle='$vehicle',amount='$amount',user_name='$user_name',entry_time='$current_datetime' WHERE vehicle_cleaning_service_id = $vehicle_cleaning_service_id ";
                            ...
                            <div class="card-body">
                              <form class="form-horizontal form-material" action="" method="post" enctype="multipart/form-data" autocomplete="off">
                                  <div class="form-group">
                                      <label class="col-md-12">Vehicle</label>
                                      <div class="col-md-12">
                                          <input type="text" name="vehicle" placeholder=""
                                              class="form-control form-control-line" value="<?php echo $vehicle; ?>" required>
                                      </div>
                                  </div>
                                  <div class="form-group">
