<?php
 ...
 <?php
   ...
   if(isset($_POST['submit']))
   {
       ...
       $sql = "INSERT INTO          tb_office_cleaning_service(no_of_cleaner,hour,amount,user_name,entry_time)values('$no_of_cleaner','$hour','$amount','$user_name','$current_datetime')";
        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-12">
                        <h4 class="page-title">Add office Cleaning Service</h4>
