 ...
 <?php
   ...
   if(isset($_GET['vehicle_cleaning_booking_id']))
   {
     ...
     while($getData = $result->fetch_assoc())
     {
       ...
       $vehicle_cleaning_booking_id = $getData['vehicle_cleaning_booking_id'];
       $name               = $getData['name'];
       $phone              = $getData['phone'];
       $email              = $getData['email'];
...
<head>
    ...
    <title>View Booking table Vehicle Cleaner</title>
        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-12">
                        <h4 class="page-title">View Booking table Vehicle Cleaner</h4>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#">Home</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">View Booking table Vehicle Cleaner</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <form class="form-horizontal form-material">
                                  <p><strong>Booking_Id: <?php echo $vehicle_cleaning_booking_id; ?></strong></p>
                                   ...
                                   <p><strong>Vehicle: <?php echo $vehicle; ?></strong></p>
