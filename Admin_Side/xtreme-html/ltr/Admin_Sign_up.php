...
<?php
      ...
      if(checkEmail())
      {
        if(checkPhone())
        {
          if(matchPassword())
          {
            ...
            $sql = "INSERT INTO          tb_admin(user_name,email,phone,password,added_by,entry_time)values('$user_name','$email','$phone','$password','$added_by','$current_datetime')";
  ...
  {
    $db     = new Database();
    $sql    = "SELECT * FROM tb_admin WHERE user_name='".$_POST['user_name']."'";
    $result = $db->link->query($sql) or die($this->link->error.__LINE__);
    if($result->num_rows > 0)
    {
        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-12">
                        <h4 class="page-title">Sign up page</h4>
